...
def load_models():
    return {
        "highbp": joblib.load(os.path.join(MODEL_DIR, "model_highbp.pkl")),
        "diabetes": joblib.load(os.path.join(MODEL_DIR, "model_diabetes.pkl")),
        "cardio": joblib.load(os.path.join(MODEL_DIR, "model_cardio.pkl"))
    }
